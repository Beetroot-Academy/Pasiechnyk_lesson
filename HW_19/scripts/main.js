...
let summ1 = +prompt("Введіть число");
let summ2 = +prompt("Введіть ще одне число");
let result = 0;
for (let i = summ1; i <= summ2; i++) {
    result += i;
}
...
let numDivisor = prompt("Введіть число");
for(let i = 1; i <= numDivisor; i++) {
    if(numDivisor % i == 0) {
        alert ( i );
    }
}
